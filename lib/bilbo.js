...
function bilbo(config) {
  ...
  // scans the whole dir
  helpers.ensureDir(destPath, function process() {
    ...
    new Glob('**/*.md')
      ...
      .on('end', function() {
        ...
        files.forEach(function(file) {
          var output = helpers.toHtml(fs.readFileSync(file.path, 'utf8'), config),
          ...
          helpers.ensureDir(dest, function() {
